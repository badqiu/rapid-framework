...
class OracleRdbmsSpecifics extends RdbmsSpecifics
{
  ...
  String formatParameterObject(Object object)
  {
    ...
    {
      return "to_timestamp('" + new SimpleDateFormat("yyyy-MM-dd HH:mm:ss.SSS").
        format(object) + "', 'yyyy-mm-dd hh24:mi:ss.ff3')";
    }
    else if (object instanceof Date)
    {
      return "to_date('" + new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").
        format(object) + "', 'yyyy-mm-dd hh24:mi:ss')";
    }
    else
    {
