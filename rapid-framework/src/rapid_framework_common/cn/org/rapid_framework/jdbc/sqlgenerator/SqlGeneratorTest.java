...
public class SqlGeneratorTest {
	...
	SpringNamedSqlGenerator singleGenerator = new SpringNamedSqlGenerator(table);
	...
	SpringNamedSqlGenerator multiGenerator = new SpringNamedSqlGenerator(multiKeyTable);
