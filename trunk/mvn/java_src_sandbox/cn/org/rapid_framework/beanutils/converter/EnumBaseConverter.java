...
public class EnumBaseConverter implements Converter {
	...
	private Object convertEnumBase2TargetType(Class type, Object value) {
		...
		if(!type.isInstance(value)) {
			throw new ConversionException("enum type miss match,targetType:"+type+" actual "+enumBase.getClass().getName()+".getCode().getClass():"+enumBase.getCode().getClass().getName());
		}
