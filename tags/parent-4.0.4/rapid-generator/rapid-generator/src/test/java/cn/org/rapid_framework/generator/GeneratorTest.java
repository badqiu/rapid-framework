...
public class GeneratorTest extends Assert {
	...
	String tempOutDir = System.getProperty("java.io.tmpdir")
			+ "/for_test_question_nation";
	...
	public void setUp() throws Exception {
		...
		// �뽫 context.checking(new Expectations(){ })
		// ��ط���Ǩ��������ĸ������Է�����.
		// ����ע�͵��ķ������Ը����Ҫ�ֹ�����ʹ�ã�����Ҫ����ɾ��
		/*
        */
	...
	public void test_generateBy_for_test_question_nation() throws Throwable {
		...
		generator.setTemplateRootDir(FileHelper
				.getFileByClassLoader("for_test_question_nation"));
	...
	public void test_zip_file() throws Throwable {
		...
		generator.setTemplateRootDir(FileHelper
				.getFileByClassLoader("for_test_zip/for_test_zip.zip"));
	...
	public void test_jar_file() throws Throwable {
		...
		File templateRoot = FileHelper
				.getFileByClassLoader("com/mysql/jdbc/log");
